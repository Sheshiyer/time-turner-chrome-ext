...
const ProfilePage: React.FC<ProfilePageProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
      <div className="w-full h-full bg-black/30 backdrop-blur-md overflow-hidden glass-effect">
        <div className="h-full flex">
          {/* Sidebar */}
          <div className="w-1/4 border-r border-white/10 p-3">
              ...
              {sections.map((section) => (
                <div key={section.id}>
                  <button
                    ...
                    className={`w-full flex items-center justify-between p-1.5 rounded-lg transition-colors text-sm ${
